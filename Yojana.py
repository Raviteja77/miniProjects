...
window = Tk()
window.title("Yojana GUI")
window.geometry("700x450")
window.config(background='black')

style = ttk.Style(window)
style.configure('', tabposition='wn', )

# TAB LAYOUT
tab_control = ttk.Notebook(window, style='')
...
tab_control.add(tab1, text=f'{"Home":^35s}')
tab_control.add(tab2, text=f'{"File":^35s}')
tab_control.add(tab3, text=f'{"URL":^35s}')
tab_control.add(tab4, text=f'{"Comparer ":^35s}')
tab_control.add(tab5, text=f'{"About ":^35s}')

label1 = Label(tab1, text='Yojana', padx=5, pady=5)
...
tab_control.pack(expand=7, fill='both')
...
button2 = Button(tab1, text="Summarize", command=get_summary, width=12, bg='red', fg='#fff')
...
# About TAB
about_label = Label(tab5, text="YOJANA Version 2.0 \n RAVI TEJA @G", pady=5, padx=5)
